...
<head>
    ...
    <title>Xác nhận đơn hàng từ 22.Décembre</title>
</head>
<body style="margin: 0; padding: 0; background-color: #f4f4f4; font-family: 'Georgia', serif; -webkit-font-smoothing: antialiased;">
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="600" style="background-color: #ffffff; max-width: 600px; width: 100%; border-radius: 4px; overflow: hidden; box-shadow: 0 4px 10px rgba(0,0,0,0.05);">
                    ...
                    <tr>
                        <td align="center" style="padding: 40px 0 20px 0; border-bottom: 1px solid #eeeeee;">
                            <h1 style="margin: 0; font-size: 28px; letter-spacing: 4px; text-transform: uppercase; color: #333333; font-family: 'Georgia', serif;">
                                22.DÉCEMBRE
                            </h1>
                    ...
                    <tr>
                        <td style="padding: 40px 40px 20px 40px;">
                            ...
                            <p style="margin: 0 0 20px 0; color: #666666; line-height: 1.6; font-size: 14px;">
                                Đơn hàng của bạn tại <strong>22.Décembre</strong> đã được tiếp nhận và đang trong quá trình xử lý. Chúng tôi sẽ sớm gửi kiện hàng thời trang này đến tay bạn.
                            </p>
                            ...
                            <div style="background-color: #f9f9f9; border: 1px solid #eeeeee; padding: 20px; border-radius: 4px; margin-bottom: 30px;">
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        ...
                                        <td align="right" style="padding-bottom: 10px; font-weight: bold; color: #333333;">#{{ $order->order_code }}</td>
                                    </tr>
                                    <tr>
                                        <td style="padding-top: 10px; border-top: 1px solid #e0e0e0; color: #333; font-weight: 600;">Tổng thanh toán</td>
                                        <td align="right" style="padding-top: 10px; border-top: 1px solid #e0e0e0; color: #333333; font-weight: 700; font-size: 16px;">
                            ...
                            <div style="text-align: center; margin-bottom: 30px;">
                                ...
                                <a href="{{ $trackingLink }}" style="background-color: #A08B7A; color: #ffffff; padding: 14px 30px; text-decoration: none; font-weight: bold; border-radius: 2px; font-size: 14px; display: inline-block; text-transform: uppercase; letter-spacing: 1px;">
                    ...
                    <tr>
                        <td style="background-color: #A08B7A; color: #ffffff; padding: 30px; text-align: center;">
                            <p style="margin: 0 0 10px 0; font-size: 14px; font-weight: bold; letter-spacing: 2px;">22.DÉCEMBRE</p>
                            <p style="margin: 0 0 10px 0; font-size: 12px; color: #cccccc;">
                                Đẳng cấp thời trang của bạn.
                            </p>
                            <p style="margin: 0; font-size: 11px; color: #666666;">
                                &copy; {{ date('Y') }} 22.Décembre Store. All rights reserved.
                            </p>
                        </td>
                    </tr>
                </table>
