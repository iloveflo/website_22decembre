...
<head>
    ...
    <title>Cảm ơn bạn đã mua sắm tại 22.Décembre</title>
</head>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="600" style="background-color: #ffffff; max-width: 600px; width: 100%; border-radius: 4px; overflow: hidden; box-shadow: 0 4px 10px rgba(0,0,0,0.05);">
                    ...
                    <tr>
                        <td align="center" style="padding: 40px 0 20px 0; border-bottom: 1px solid #eeeeee;">
                            <h1 style="margin: 0; font-size: 26px; letter-spacing: 4px; text-transform: uppercase; color: #333333; font-family: 'Georgia', serif;">
                                22.DÉCEMBRE
                            </h1>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding: 40px 40px 30px 40px; text-align: center;">
                            <div style="color: #333333; font-size: 24px; letter-spacing: 5px; margin-bottom: 20px;">
                                ★★★★★
                            </div>
                            ...
                            <p style="margin: 0 0 20px 0; color: #666666; line-height: 1.6; font-size: 15px;">
                                Đơn hàng <strong>#{{ $order->order_code }}</strong> của bạn đã hoàn thành. Chúng tôi hy vọng bạn yêu thích sản phẩm mới từ 22.Décembre cũng như cách chúng tôi phục vụ bạn.
                            </p>
                            ...
                            <div style="margin-bottom: 30px;">
                                <a href="{{ rtrim(env('FRONTEND_URL', 'http://localhost:8000'), '/') . '/reviews/' . $order->order_code }}" style="background-color: #A08B7A; color: #ffffff; padding: 14px 30px; text-decoration: none; font-weight: bold; border-radius: 2px; font-size: 14px; display: inline-block; text-transform: uppercase; letter-spacing: 1px;">
                    ...
                    <tr>
                        <td style="background-color: #fafafa; padding: 20px; text-align: center; border-top: 1px solid #eeeeee;">
                            <p style="margin: 0 0 5px 0; font-size: 12px; font-weight: bold; letter-spacing: 1px; color: #333333;">22.DÉCEMBRE STUDIO</p>
